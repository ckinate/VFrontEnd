...
import {
  ...
  AddNewPageOutput, AddWidgetInput, RenamePageInput, SavePageInput, Page, Widget, WidgetFilterOutput, WidgetOutput, VendorsServiceProxy, WorkflowQueryDto
...
export class CustomizableDashboardComponent extends AppComponentBase implements OnInit, OnDestroy {
  ...
  navigateToQuery(){
      ...
      this.router.navigate(['../../../main/vendorMgt/querydetails'], { relativeTo: this.route });
  }
