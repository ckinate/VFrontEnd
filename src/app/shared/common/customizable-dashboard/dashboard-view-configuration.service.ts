...
import { WidgetVendorStatsComponent } from './widgets/widget-vendor-stats/widget-vendor-stats.component';
...
export class DashboardViewConfigurationService {
  ...
  private initializeConfiguration() {
    ...
    let vendorTopStats = new WidgetViewDefinition(
        DashboardCustomizationConst.widgets.tenant.vendorTopStats,
        WidgetVendorStatsComponent,
      );
   ...
   //add your host side widgets here
    ...
    this.WidgetViewDefinitions.push(vendorTopStats);
  }
}
