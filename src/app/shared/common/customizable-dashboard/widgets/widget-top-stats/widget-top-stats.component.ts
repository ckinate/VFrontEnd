...
import { TenantDashboardServiceProxy, VendorDashboardServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class WidgetTopStatsComponent extends WidgetComponentBaseComponent implements OnInit {
  ...
  constructor(injector: Injector,
    private _tenantDashboardServiceProxy: TenantDashboardServiceProxy, private _vendorDashboard: VendorDashboardServiceProxy
  ) {
    super(injector);
